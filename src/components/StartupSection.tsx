    ...
    return (
        <div className="flex flex-col items-center justify-between p-5 h-screen border-black border-b">
            <div className="flex flex-col text-center">
                <h1 className={`${isMobile ? "text-[4rem]" : "text-[7rem]"}`}>
                    Launch Your Business <span className="underline underline-offset-8">Not in Months</span> But <span className="underline underline-offset-8">In Weeks</span>
                </h1>
